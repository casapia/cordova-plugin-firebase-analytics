...
module.exports = function (context) {
    ...
    const enableAppTracking = Boolean(configParser.getPlatformPreference("EnableAppTrackingTransparencyPrompt", "ios"));
    if (!enableAppTracking) {
        delete plistContent['NSUserTrackingUsageDescription'];
